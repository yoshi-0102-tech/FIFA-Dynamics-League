...
- 2026-07-24: 設定画面にバージョン・ビルド・更新日を表示し、アプリ内の`/updates`と`CHANGELOG.md`に更新履歴を追加。
...
- **バージョン・更新情報**: `package.json`のバージョンとVercelのコミットSHAを設定画面に表示。`/updates`と`CHANGELOG.md`で更新履歴を管理
